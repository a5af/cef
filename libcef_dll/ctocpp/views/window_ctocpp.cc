...
//
// $hash=a5ebebb3a98409dbf566e4ab4e6836e04fa77d88$
//
...
NO_SANITIZE("cfi-icall") bool CefWindowCToCpp::BeginWindowDrag() {
  shutdown_checker::AssertNotShutdown();

  auto* _struct = GetStruct();
  if (!_struct->begin_window_drag) {
    return false;
  }
  ...
  // Execute
  int _retval = _struct->begin_window_drag(_struct);
